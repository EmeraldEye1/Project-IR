...
def genre_to_category(df):
    ...
    return df
    f = pickle.load(open('C:/Users/asus/Project-IR/resources/anime_data.pkl', 'rb'))
    print(f)
def create_text_spelling_check():
    ...
    spell = resources.sub(r'[^\w\s]', '', spell)
    spell = resources.sub(r'\n', '', spell)
    pickle.dump(spell, open('C:/Users/asus/Project-IR/resources/spelling_check.pkl', 'wb'))
